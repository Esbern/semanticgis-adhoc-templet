...
- Use a documentation-first, phase-gated lifecycle for all data sources:
  ...
  - **write design brief for analysis logic** (in `04_Analytics/Analytical_Recipe.md`) for analysis tasks that involve more than one distinct transformation, aggregation, or modeling operation on the sanitized dataset
